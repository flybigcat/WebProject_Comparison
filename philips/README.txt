...
-----------------------
1. Under Eclipse IDE, run web application "philips' on server 
2. choose Tomcat (right version. e.g. Tomcat 7.0) server
3. Application start
4. default web is http://localhost:8080/philips/ 
...
Download the following JAR files and save in the directory of philips/WebContent/WEB-INF/lib
...
Default website is http://localhost:8080/philips/ which is home entry page

6. If a different format is used in the input file, modification is only needed for RecordEntry.java.

7. Sample test files are in the philips/test/ directory 
